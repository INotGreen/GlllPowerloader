## 说明：
该项目的初衷是为了为测试人员提供现成工具以及为一些新手学习者提供免杀思路和框架代码，我并没有从该项目上得到任何盈利迫于开源项目引来不必要的麻烦，我不得不将停止该项目的维护，并且以后不会参与开源Bypass的开发。如果你有需求或者学习免杀的意向请联系我，可私人定制免杀(可过国内外主流杀软)，获取免杀资料可加知识星球。
