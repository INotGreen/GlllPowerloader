...
在版本2022-6-3的C++ loader中，Windows Defender标记了这个样本，我在新版本中进行了优化，并且绕过主流防病毒的检测，并且迫于开源项目对我个人引来不必要的麻烦，我没有上传代码，我不得不将停止该项目的维护，以后也不会参与开源Bypass的开发。该项目的初衷是为了为测试人员提供现成工具以及为一些新手学习者提供免杀思路和框架代码，我并没有从该项目上得到任何盈利。如果你有私人免杀的需求可联系我，详情见readme底部
