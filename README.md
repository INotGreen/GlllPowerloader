...
* 注意C#和Nim的Automation_loader，这个模块调用了System.Management.Automation.dll来编译powershell脚本，并且采用了stager的方式进行加载，因此您需要将powershell脚本上传到网页上，例如：https://pastebin.mozilla.org/.
